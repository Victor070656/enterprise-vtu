  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Betting Package / </li>
      </ol>
      <div class="row">
        <div class="col-12">
        ...
        <div class="card-body">
           ...
           <form method="POST" action="javascript:void(0)" id="betPackage">       
         <h4 align="center">Add Betting Package</h4>   
          <div class="row ">
          <input type="hidden" id="net">    
              <div class="col-6">
 <label><li class="fa fa-server"></li> Betting Company </label>
...
function fetchdisco($conn){
		$Runqry = $conn->query("SELECT * FROM betting_package");
    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
            ...
            <th>Service</td>
              ...
              $json_disco = json_decode(fetchdisco($conn));
               ...
               ?>
                <tr>
                  <td><?php echo strtoupper($pr->network); ?></td>
        ...
        var Net = $(this).val(); 
         $('#net').val(Net);
         $.ajax({url:"fetch_bet_status.php", type:'GET', data: {nwk:Net}, dataType:'json',
      success:function(re){ 
...
Toast.fire({
  ...
  text: 'Select Service'
   ...
   if(this.checked){
        ...
        var Network = $('#net').val();
       // $('#sam').text(Network);
    $.ajax({url:"bet_status.php", type:'GET', data: {status:Status,network:Network}, dataType:'json',
      success:function(data){ 
      if(data.status === true){
         const Toast = Swal.mixin({
  toast: true,
