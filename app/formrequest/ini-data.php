...
if ($status_fetch !== 'disabled') {
  ...
  $stmtSmE->bind_Param("ssssssssssss", $valu, $network, $code_fetch, $phone, $uid, $reference, $userprice_fetch, $UserEmail, $stat, $reference, $customNam, $dat);
  ...
  if ($stmtSmE->execute()) {
    ...
    strval($_SESSION['unit'] = $userprice_fetch);
...
{
  $qryPlan = $conn->query("SELECT * FROM data_package WHERE serial='$plan'");
