...
function VTPas($conn, $username, $password ,$requestId,$network, $phone,$variation_code,  $amount){
$curl       = curl_init();
...
$resp = json_decode(VTPas($conn, $username, $password ,$requestId,$network, $phone,$variation_code,  $amount));
