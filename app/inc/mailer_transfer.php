...
// send email
function SendEmail($conn, $sitname, $hosturl,$token, $fname ,$smtpHost , $smtpPort, $smtpUser, $smtpPass,$support_email,$logo,$amount,$Actname,$new_current_bal,$logoUrl){
...
$message .= "You just sent &#8358;".number_format($amount,2)." to $Actname. <br>";
$message .= "<strong>You now have &#8358;".number_format($new_current_bal,2)." in your account.</strong> <p>";
$message .= 'Regards, <p>';
