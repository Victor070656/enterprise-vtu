...
$host = "https://mobileairtimeng.com/httpapi/multichoice?userid=$mobileID&pass=$mobilekey&phone=$phone&amt=$amount&smartno=$iuc&customer=$CustomerName&invoice=$invoiceNo&billtype=$network&customernumber=$customerNumber&jsn=json";
