...
$host = "https://smartrecharge.ng/api/v2/electric/?api_key=$DisKey&product_code=$smartCode&meter_number=$iuc&amount=$amount&$callb";
...
$sav = $conn->query($qsel);
	...
	echo'<div class="alert alert-success">
				...
				Token:<strong>	'.$result['data']['token'].'</strong>,  <strong>'.$result['data']['recharge_id'].'</strong>  
									</div>'; 
