...
function showTv() {
  if (document.getElementById("gotv").checked) {
    ...
    document.getElementById("network").value =
      document.getElementById("gotv").value;
  ...
  if (document.getElementById("dstv").checked) {
    ...
    document.getElementById("networkDstv").value =
      document.getElementById("dstv").value;
  ...
  if (document.getElementById("startimes").checked) {
    ...
    document.getElementById("networkstar").value =
      document.getElementById("startimes").value;
