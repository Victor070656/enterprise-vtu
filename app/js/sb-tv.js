...
document.getElementById('network').value = document.getElementById("gotv").value;
...
document.getElementById('networkDstv').value= document.getElementById("dstv").value;		
 ...
 $('#data_type_airtel').change(function() {
	...
	document.getElementById('networkstar').value= document.getElementById("startimes").value;	
...
document.getElementById('network9mobile').value= document.getElementById("9mobile").value;		
