        ...
        <div class="container-fluid dashboard-content ">
                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">
                            <li class="fa fa-book"></li> NABTEB PIN
                        </h2>
            ...
            <div class="ecommerce-widget">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <label class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" name="carier" class="custom-control-input" value="NABTEB Result Checker" onclick="javascript:showTv();" id="smiledata"><span class="custom-control-label"><img src="assets/images/nabteb-sm.png"></span>
                                </label>
                                <p></p>
                                ...
                                <div class="float-center" id="ifData" style="display:none;">
                                    <div class="form-group">
                                        <?php $waec = $conn->query("SELECT * FROM exam_package WHERE network='nabteb' AND plancode='nabteb'");
                    ...
                    <script src="js/nabteb.js"></script>
                    <!-- customer acquistion  -->
                    <!-- ============================================================== -->
