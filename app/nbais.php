...
<?php include('inc/header.php');?> 
        ...
        <div class="dashboard-wrapper">
            <div class="dashboard-ecommerce">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title"><li class="fa fa-book"></li> NBAIS PIN </h2>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <label for="inputText3" class="col-form-label">Please Select Service</label><br>
                                            <label class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" name="carier"  class="custom-control-input" value="NBAIS Result Checker" onclick="javascript:showTv();" id="smiledata" ><span class="custom-control-label"><img src="assets/images/nbais-sl.png" ></span>
                                            </label>
              ...
              <?php $waec = $conn->query("SELECT * FROM exam_package WHERE network='nbais' AND plancode='nbais'"); 
