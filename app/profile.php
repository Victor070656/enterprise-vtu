...
$pnam = test_input($_POST['fname']);
 $plnam = test_input($_POST['lname']);
                   ...
                   <h2 class="post-title">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                	<tr>
                                		<td>Surname Name</td>
                                		<td><input class="form-control" placeholder="Enter Your Surname" name="fname" type="text" value="<?php echo $data[0]['firstname'];?> "></td>
                                	</tr>
                                    
                                   <tr>
                                		<td>Other Names</td>
                                		<td><input class="form-control" placeholder="Enter Your Other Names" name="lname" type="text" value="<?php echo $data[0]['lastname'];?>"></td>
                                	</tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo number_format($data[0]['bal'],2,'.',',');?></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                     ...
                                     <tr>
                                        ...
                                        <td><?php echo $data[0]['phone'];?></td>
                                                                                                                ...
                                                                                                                <tr>
                                            <td>Referral Link</td>
                                            <td><?php echo $data['reflink'];echo $data[0]['refid'];?></td>
                                        </tr>
