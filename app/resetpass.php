...
$oldpwd = filter_var(test_input($_POST['pwd']),FILTER_SANITIZE_STRING);

$newpwd = password_hash(filter_var(test_input($_POST['newpwd']),FILTER_SANITIZE_STRING), PASSWORD_DEFAULT);
