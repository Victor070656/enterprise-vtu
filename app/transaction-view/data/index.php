                    ...
                    <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                $comi = validate_input($_SESSION['discount']);
                                ...
                                <form method="post" id="cglitePay" action="javascript:void(0)">
                                    ...
                                    <table class="table  margin-tp-10" id="transTable">
                                        ...
                                        <tr>
                                            ...
                                            <td>₦<?php echo $_SESSION['unit']; ?>.00 + ₦0.00 <i class="conv_fee">
                                        ...
                                        <tr>
                                            ...
                                            <td>₦<d id="total_amount"><?php echo $amount; ?></d>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="30%">
                                    ...
                                    <div class="row responsive">
                                        <div class="col-4">
                                            ...
                                            <button type="submit" id="walletpay" class="btn btn-rounded btn-primary"> <i class="fas fa-fw fa-money-bill-alt"></i> Buy Data</button>
                                        </div>
