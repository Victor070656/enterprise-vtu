...
include('../../inc/jambpay.php');
	
	}else if($apiMulti->gateway === 'vtpass'){
		
	include('../../inc/jambpayVT.php');
	
		}
		else if($apiMulti->gateway === 'shago'){
		
	include('../../inc/jambpayShago.php');
	
		}
		
		
		
if($responseCode === '101' OR $responseCode ==='000'  OR $responseCode === '200'){
