...
<h2 class='margin-tp-10'>Please Confirm your Transaction Details: </h2>     
                    ...
                    <table class="table  margin-tp-10">
                       ...
                       <tr>
                            <td width="30%"> </td>
                            <td id="mainService"><img src="../../assets/images/nbais-Result-Checker.jpg" width="120" height="110" >  </td>
                        </tr>
   ...
   $('#necoPros').submit(function(e){
                e.preventDefault();  
                var data = $(this).serialize();
               
                $.ajax({
                   url: 'generate_nbais.php',
                   type: 'POST',
                   data: data,
                 beforeSend: function(){
                    $('#gen').html('Processing...'); 
  ...
  if (result.isConfirmed) {
    window.location.href="../../nabtebpin.php";
  }
})       
       $('#gen').html('Completed');
