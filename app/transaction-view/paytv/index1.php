...
<?php include('../../inc/header2.php');?>
	...
	$ikeja = $rate['IkejaElectric'];
		...
		include('../../inc/cpins.php');	
		
			
			
									if(isset($_POST['pay'])){
										
										$uid = mt_rand(784755,998935);	
...
if($apiMulti['tvactive'] == 'vtpass'){
		
	include('../inc/vbill.php');
	include('../../inc/notification.php');
		
		}
			
if($apiMulti['tvactive'] == 'clubkonnect'){
			
		include('../inc/ckbill.php');
		include('../../inc/notification.php');
			}		
									

if($apiMulti['tvactive'] == 'smartrecharge'){
			
		include('../inc/smart-tvpay.php');
		include('../../inc/notification.php');
			}			


		if($apiMulti['tvactive'] == 'mobileng'){
			
			if($network == 'startimes'){
			
				include('../inc/mobileng-startimespay.php');
				include('../../inc/notification.php');
				
			}else{
			    include('../inc/mobileng-tvpay.php'); 
			    include('../../inc/notification.php');
			}
