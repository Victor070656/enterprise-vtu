...
<?php include('../../inc/header2.php');?> 
                ...
                <div class="container-fluid dashboard-content ">
					...
					$rowTrans = mysqli_fetch_array($trans);	
						...
						if($network === 'spectranet'){
							...
							$pnt = "Spectranet 4G Internet ";
							$img = "spect-medium.jpg";
	...
	$airtelvtu = $bil['airtelvtu'];
		...
		$affpay = $afi['mtnvtu'];
				...
				$payko = strval(floatval($affpay/100)* floatval($xamount));
				
			$comi = strval(floatval($per/100)* floatval($xamount));
			$debit = strval(floatval($pinNumber) * floatval($amount));
			$adcom = array($cwal,$comi);
		    $apComs= array_sum($adcom);
...
include('../../inc/spectranet-pay.php');	
...
<h2 class='margin-tp-10'><?php echo $tranDetail; ?> </h2>     
                      ...
                      <?php 
                      $Netary =  array("mtn","airtel","etisalat","glo","Reseller Account Upgrade","mtn-data","airtel-data","glo-data","etisalat-data","01","02","03","04","ntel","spectranet");
                            ...
                            <td colspan="2">
                                ...
                                <div class="pay-button">
                                     ...
                                     <div class="col-sm-6 pl-0">
                                                ...
                                                <p class="text-center">
                                                    <button type="submit" name="pay" class="btn btn-rounded btn-primary"><i class="fas fa-fw fa-wifi"></i> Buy Data</button>
