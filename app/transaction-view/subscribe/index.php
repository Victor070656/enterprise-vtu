...
<h5 class='alert alert-info' align="center"><li class="fa fa-exclamation-circle"></li> Activate your account to start generating and printing recharge cards with no special software. </h5>     
