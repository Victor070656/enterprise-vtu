                            ...
                            <div class="card-body">
                                ...
                                <form method="post" id="cglitePay" action="javascript:void(0)">
                                    ...
                                    <table class="table  margin-tp-10" id="transTable">
                                        ...
                                        <tr>
                                            <td width="30%">IUC/Smartcard Number</td>
                                    ...
                                    <div class="row responsive">
                                        <div class="col-8">
                                            ...
                                            <input type="hidden" name="cable_id" value="<?php echo $_SESSION['cable_id']; ?>">
                                            <input type="hidden" name="plan_id" value="<?php echo $_SESSION['plan_id']; ?>">
