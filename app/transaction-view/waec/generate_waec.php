...
include('../../inc/waecpay.php');
	...
	include('../../inc/waecpayVT.php');
	
		}
		else if($apiMulti->gateway === 'shago'){
		
	include('../../inc/waecpayShago.php');
	
		}
		
		elseif($apiMulti->gateway === 'mobileng'){
		
	include('../../inc/waecpaymobile.php');
		
		}
		
if($responseCode == '000' or $responseCode =='101' or $responseCode =='100' or $responseCode == '200'){
