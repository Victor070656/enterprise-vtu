...
<h2 class='margin-tp-10'>Please Confirm your Transaction Details: </h2>     
                    ...
                    <table class="table  margin-tp-10">
                       ...
                       <tr>
                            <td width="30%"> </td>
                            <td id="mainService"><img src="../../assets/images/WAEC-Result-Checker.jpg" width="120" height="110" >  </td>
                        </tr>
                    ...
                    <tr>
                       ...
                       <form method="post" action="javascript:void(0)" id="WaecPros">                                                    
   ...
   $('#WaecPros').submit(function(e){
                e.preventDefault();  
                var data = $(this).serialize();
               
                $.ajax({
                   url: 'generate_waec.php',
                   type: 'POST',
                   data: data,
                 beforeSend: function(){
                    $('#gen').html('Processing...'); 
